...
enum EMDLabel
{
	...
	EMDL_CTF_DELTAZ,	//BLock-based dz
	EMDL_PARTICLE_SERIAL_NUMBER,	//BLock-based original particle number
...
private:
    StaticInitialization()
    {
		...
		EMDL::addLabel(EMDL_CTF_DELTAZ, EMDL_DOUBLE, "rlnDeltaZ", "Value of the block Z-distance to mass center");
		EMDL::addLabel(EMDL_PARTICLE_SERIAL_NUMBER, EMDL_INT, "rlnParticleSerialNumber", "which particle this subparticle belongs to");
